...
public final class LdJsonWriter extends JsonWriter implements JavaScript, Json, LdJson, Text, Url {
   ...
   * @param  isNoClose  Called to determine result of {@link LdJsonWriter#isNoClose()}
   * @param  closer  Called on {@link LdJsonWriter#close()}, which may optionally perform final suffix write and/or close the underlying writer,
   ...
   *
   * @see  LdJsonWriter#DEFAULT_IS_NO_CLOSE
   * @see  LdJsonWriter#DEFAULT_CLOSER
   */
  public LdJsonWriter(
      EncodingContext encodingContext,
      MediaEncoder encoder,
