...
public interface XhtmlAttribute extends Encode {
	...
	@Deprecated
	@Override
	default XhtmlAttribute encode(MediaType contentType, CharSequence csq) throws IOException {
	...
	@Deprecated
	@Override
	default XhtmlAttribute encode(MediaType contentType, CharSequence csq, int start, int end) throws IOException {
