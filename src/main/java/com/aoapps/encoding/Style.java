...
public interface Style extends Encode {
	...
	@Deprecated
	@Override
	default Style encode(MediaType contentType, CharSequence csq) throws IOException {
	...
	@Deprecated
	@Override
	default Style encode(MediaType contentType, CharSequence csq, int start, int end) throws IOException {
