        ...
        if (
          ...
          if (buffered) {
            ...
            if (lookupMarkup != null) {
              lookupMarkup.appendPrefixTo(markupType, encoder, out);
            }
            encoder.write(str, out);
            if (lookupMarkup != null) {
              lookupMarkup.appendSuffixTo(markupType, encoder, out);
            }
          } else {
      ...
      if (newEncoder.isBuffered()) {
        ...
        if (csq != null) {
          ...
          if (
            ...
            if (lookupMarkup != null) {
              lookupMarkup.appendSuffixTo(markupType, newEncoder, optimized);
            }
          }
        }
