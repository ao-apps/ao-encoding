...
public interface Mysql extends Encode {
	...
	@Deprecated
	@Override
	default Mysql encode(MediaType contentType, CharSequence csq) throws IOException {
	...
	@Deprecated
	@Override
	default Mysql encode(MediaType contentType, CharSequence csq, int start, int end) throws IOException {
