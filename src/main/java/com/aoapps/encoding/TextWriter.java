...
public final class TextWriter extends WhitespaceWriter implements Xhtml, XhtmlAttribute, Style, JavaScript, Json, LdJson, Text, Url, Sh, Mysql, Psql {
   ...
   * @param  isNoClose  Called to determine result of {@link TextWriter#isNoClose()}
   * @param  closer  Called on {@link TextWriter#close()}, which may optionally perform final suffix write and/or close the underlying writer,
   ...
   *
   * @see  TextWriter#DEFAULT_IS_NO_CLOSE
   * @see  TextWriter#DEFAULT_CLOSER
   */
  public TextWriter(
      EncodingContext encodingContext,
      MediaEncoder encoder,
