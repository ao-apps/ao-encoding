 ...
 */
public final class JsonWriter extends WhitespaceWriter implements JavaScript, Json, LdJson, Text, Url {
	...
	public JsonWriter(
		...
		assert encoder.isValidatingMediaInputType(MediaType.JSON);
	}
