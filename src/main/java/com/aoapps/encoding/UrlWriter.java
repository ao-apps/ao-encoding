...
public final class UrlWriter extends MediaWriter implements Url {
   ...
   * @param  isNoClose  Called to determine result of {@link UrlWriter#isNoClose()}
   * @param  closer  Called on {@link UrlWriter#close()}, which may optionally perform final suffix write and/or close the underlying writer,
   ...
   *
   * @see  UrlWriter#DEFAULT_IS_NO_CLOSE
   * @see  UrlWriter#DEFAULT_CLOSER
   */
  public UrlWriter(
      EncodingContext encodingContext,
      MediaEncoder encoder,
