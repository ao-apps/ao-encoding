...
public interface Psql extends Encode {
	...
	@Deprecated
	@Override
	default Psql encode(MediaType contentType, CharSequence csq) throws IOException {
	...
	@Deprecated
	@Override
	default Psql encode(MediaType contentType, CharSequence csq, int start, int end) throws IOException {
