 ...
 */
public final class JavaScriptWriter extends WhitespaceWriter implements JavaScript, Json, LdJson, Text, Url {
	...
	public JavaScriptWriter(
		...
		assert encoder.isValidatingMediaInputType(MediaType.JAVASCRIPT);
	}
	...
	@Override
	JavaScriptWriter newMediaWriter(
		EncodingContext encodingContext,
		MediaType inputType,
		MediaEncoder encoder,
		Writer out,
